...
class RestaurantDeviceService:
    ...
    def _load_restaurant_ouis(self) -> Dict[str, Dict[str, str]]:
        ...
        return {
            ...
            '00:12:16': {'manufacturer': 'Hikvision', 'device_type': 'security_camera', 'category': 'security'},
            '28:57:be': {'manufacturer': 'Hikvision', 'device_type': 'security_camera', 'category': 'security'},
            '44:19:b6': {'manufacturer': 'Hikvision', 'device_type': 'security_camera', 'category': 'security'},
            '68:64:4b': {'manufacturer': 'Hikvision', 'device_type': 'security_camera', 'category': 'security'},
            'bc:ad:28': {'manufacturer': 'Hikvision', 'device_type': 'security_camera', 'category': 'security'},
            
            # Axis Communications (Security cameras)
            '00:40:8c': {'manufacturer': 'Axis Communications', 'device_type': 'security_camera', 'category': 'security'},
            'ac:cc:8e': {'manufacturer': 'Axis Communications', 'device_type': 'security_camera', 'category': 'security'},
    ...
    def _load_device_patterns(self) -> Dict[str, Dict[str, str]]:
        ...
        return {
            ...
            'pos': {
                'patterns': ['pos-', 'register-', 'terminal-', 'aloha-', 'micros-', 'par-'],
                'device_type': 'pos_terminal',
                'category': 'point_of_sale',
                'icon_hint': 'pos'
            },
            ...
            # Camera Patterns
            'camera': {
                'patterns': ['cam-', 'camera-', 'dvr-', 'nvr-', 'security-', 'hikvision-', 'axis-'],
    ...
    def identify_restaurant_device(self, mac: str, hostname: Optional[str] = None, 
                                 manufacturer: Optional[str] = None) -> Dict[str, str]:
        """
        ...
        if hostname and result['confidence'] != 'high':
            ...
            for pattern_name, pattern_info in self.device_patterns.items():
                if any(pattern in hostname_lower for pattern in pattern_info['patterns']):
                    result.update({
        ...
        if manufacturer and result['confidence'] == 'low':
            ...
            restaurant_manufacturers = [
                'ncr', 'par technology', 'micros', 'ingenico', 'verifone', 
                'hikvision', 'axis', 'elo touch', 'qsr automations'
            ]
    ...
    def get_restaurant_device_icon_path(self, device_info: Dict[str, str]) -> Tuple[str, str]:
        """
        ...
        if icon_hint in restaurant_icons:
            ...
            return fallback_icons.get(device_type, ('icons/nd/laptop.svg', 'Restaurant Device'))
