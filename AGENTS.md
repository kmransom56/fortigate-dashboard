...
# Step 2: Use the port in your docker-compose.yml or configuration
# Example: ports: - "${PORT}:8000"
...
For fortigate-dashboard project, a local wrapper is also available:

```bash
./scripts/check_port.sh [COMMAND] [OPTIONS]
```

This provides the same functionality but scoped to the fortigate-dashboard project context.
