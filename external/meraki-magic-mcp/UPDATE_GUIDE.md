...
```bash
cd /Users/keith.ransom/meraki-magic-mcp
...
```bash
cd /Users/keith.ransom/meraki-magic-mcp && source .venv/bin/activate && python3 update_meraki.py
```
...
0 9 * * 1 cd /Users/keith.ransom/meraki-magic-mcp && .venv/bin/python3 update_meraki.py
```
...
<dict>
    ...
    <array>
        <string>/Users/keith.ransom/meraki-magic-mcp/.venv/bin/python3</string>
        <string>/Users/keith.ransom/meraki-magic-mcp/update_meraki.py</string>
    </array>
    ...
    <string>/Users/keith.ransom/meraki-magic-mcp/update.log</string>
    <key>StandardErrorPath</key>
    <string>/Users/keith.ransom/meraki-magic-mcp/update_error.log</string>
</dict>
</plist>
```
