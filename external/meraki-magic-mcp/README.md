...
**macOS:**
```bash
git clone https://github.com/kmransom56/meraki-magic-mcp-enhanced.git
cd meraki-magic-mcp
python3 -m venv .venv
...
```json
{
  "mcpServers": {
    "Meraki_Magic_MCP": {
      "command": "/Users/<YOUR USERNAME>/meraki-magic-mcp/.venv/bin/fastmcp",
      "args": [
        "run",
        "/Users/<YOUR USERNAME>/meraki-magic-mcp/meraki-mcp-dynamic.py"
      ]
    }
  }
}
...
```json
{
  "mcpServers": {
    "Meraki_Magic_MCP": {
      "command": "C:/Users/<YOUR USERNAME>/meraki-magic-mcp/.venv/Scripts/fastmcp.exe",
      "args": [
        "run",
...
```json
{
  "mcpServers": {
    "Meraki_Curated": {
      "command": "/Users/<YOUR USERNAME>/meraki-magic-mcp/.venv/bin/fastmcp",
      "args": ["run", "/Users/<YOUR USERNAME>//meraki-magic-mcp/meraki-mcp.py"]
    },
    "Meraki_Full_API": {
      "command": "/Users/<YOUR USERNAME>//meraki-magic-mcp/.venv/bin/fastmcp",
      "args": ["run", "/Users/<YOUR USERNAME>//meraki-magic-mcp/meraki-mcp-dynamic.py"]
    }
  }
}
```
